...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Data', fields ['slug']
        db.create_unique(u'applications_data', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Data', fields ['slug']
        db.delete_unique(u'applications_data', ['slug'])
