...
SETTINGS = getattr(settings, 'APP_SETTINGS', {})
...
def get_models():
    ...
    """
    models = {}
    for model in SETTINGS.get('MODELS', ('auth.User','relationships.RelationshipStatus')):
...
def get_action_manager():
    ...
    """
    mod = SETTINGS.get('MANAGER', 'applications.managers.ActionManager')
