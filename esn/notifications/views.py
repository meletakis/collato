...
@login_required
def unread(request):
    return render(request, 'notifications/list_unread.html', {
...
def new_notification ( request, from_user, to_user, status ):
	notify.send(from_user,  recipient=to_user, verb=status)
